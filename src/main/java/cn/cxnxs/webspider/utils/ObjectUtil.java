...
public class ObjectUtil {
	 ...
	 * @throws Exception
	 */
	public static void transValues(Object source, Object target) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		// 获得实体类
		...
		for (Field field : fields) {
			...
			if (object != null) {
				if (fieldMap.get(fieldName) != null) {
					...
					//比较参数类型
					if (fieldMap.get(fieldName).getType().equals(field.getType())){
						// 这是set方法
